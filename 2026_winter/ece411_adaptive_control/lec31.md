...
* Consider the estimate: $\hat w(k) = \eta _0(k) + Ge(k) - A\eta _1(k) + B\eta _2(k)$
	* $\alignedeqntwo[t]{\hat w(k)}{\eta _0(k + 1) + Ge(k + 1) - A\eta _1(k + 1) + B\eta _2(k + 1)}{F\eta _0(k) + FGe(k) + G(Ae(k) - Bu(k) + d_*) - A(F\eta _1(x) - Ge(k)) + B(F\eta _2(k) + Gu(k))}{F(\eta _0(k) + Ge(k) + A\eta _1(k) + B\eta _2(k)) + Gd_*}{F\hat w(k) + Gd_*}$
